...
public class Message {
    ...
    public static final String ERROR_STUDENT_EXISTS = "Student with this ID already exists!";
    ...
    public static final String HEADER_STUDENT_LIST = String.format("%-5s%-15s%-15s%-20s","ID", "Name", "Semester", "Courses");
